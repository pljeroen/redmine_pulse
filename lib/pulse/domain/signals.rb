...
module Pulse
  module Domain
    ...
    module Signals
      ...
      # Coverage gap — active iff open_issue_count > 0.
      ...
      # — never divides by zero. The config is ACCEPTED but UNUSED: the 3 coverage
      # dimensions are FIXED, so weights/other config keys never alter the result.
