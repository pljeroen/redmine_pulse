...
# RED until Pulse::Domain::RetrospectiveBucket exists.
class TimelineBucketValueObjectTest < Minitest::Test
  ...
  # --- TC-04: explicit Date boundaries tagged :derived_bucket ---
  ...
  # --- TC-07: event_count is a real Integer >= 0 ---
  ...
  # --- TC-04: reject a non-Date / Time boundary (no invented time-of-day) ---
  ...
  # --- TC-07: optional breakdown sums to event_count when present ---
